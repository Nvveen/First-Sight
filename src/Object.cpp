...
Object::init ()
{
    ...
    auto rotate = [&](glm::mat4 mat)->glm::mat4 {
        glm::mat4 m = glm::translate(glm::mat4(1.0f), glm::vec3(13, 9, 18));
        m *= glm::rotate(glm::mat4(1.0f), angle, glm::vec3(1, 0, 0));
        m *= glm::translate(glm::mat4(1.0f), glm::vec3(-13, -9, -18));
        m *= mat;
        return m;
    };
    model_->setAnimation(rotate, 500, 1, true);
    angle = 4.5f;
    model_->setAnimation(rotate, 500, 1, true);
